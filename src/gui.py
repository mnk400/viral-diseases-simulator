...
if __name__ == '__main__':
    ...
    # style = ttk.Style()
    # style.configure("Horizontal.TScale", sliderlength=10,  background="#ccc", fg = "red", troughcolor='#73B5FA')
    # style.configure('my.Horizontal.TScale', )
    ttk.Style().configure("Horizontal.TScale", sliderlength=10, relief="flat",background="#ffffff")

    # s1 = tk.Scale(root, orient='horizontal', tickinterval=0.2, from_=-1, 
                #   to=1, showvalue=True, resolution=0.1,  sliderlength=10)
    s2 = TtkScale(root, style='Horizontal.TScale', orient='horizontal', 
