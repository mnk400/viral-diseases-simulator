...
config_frame = SetConfigFrame(master=action_frame, height=float(action_frame.winfo_reqheight()), width=float(action_frame.winfo_reqwidth()))
config_frame.pack()
...
load_config_frame = LoadConfigFrame(master=action_frame1, height=height/2, width=float(action_frame1.winfo_reqwidth()))
sim_command_frame = SimCommandFrame(master=action_frame1, height=height/2, width=float(action_frame1.winfo_reqwidth()))
