...
class DataStore:
    """
    Singleton class used to share data between two different classes in real
    time.
    """
    __instance__ = None
    ...
    def get_all_mask_effectiveness(self):
        ...
        self.mask_effectiveness['cloth_mask'] = \
            self.get_mask_effectiveness_cloth_mask()
        self.mask_effectiveness['surgery_mask'] = \
            self.get_mask_effectiveness_surgical_mask()
        self.mask_effectiveness['n95_mask'] = \
            self.get_mask_effectiveness_n95_mask()
    ...
    def get_mortality_rate_twenty_to_fortynine(self):
        return float(self.mortality_rate_twenty_to_fortynine.get()
                     .split('%')[0])

    def get_mortality_rate_fifty_to_sixtynine(self):
        return float(self.mortality_rate_fifty_to_sixtynine.get()
                     .split('%')[0])
    ...
    def get_all_mortality_rates(self):
        ...
        self.mortality_rate['0-19'] = self \
            .get_mortality_rate_zero_to_nineteen()/100
        self.mortality_rate['20-49'] = self \
            .get_mortality_rate_twenty_to_fortynine()/100
        self.mortality_rate['50-69'] = self \
            .get_mortality_rate_fifty_to_sixtynine()/100
        self.mortality_rate['70-100'] = self \
            .get_mortality_rate_seventyplus()/100
