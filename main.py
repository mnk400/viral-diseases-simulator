...
class Main(object):
    ...
    def load_config(self) -> None:
        ...
        self.size = self.config_util \
            .getIntegerValue("area.stats", "total_population")
        self.min_age = self.config_util \
            .getIntegerValue("people.stats", "min_age")
        self.max_age = self.config_util \
            .getIntegerValue("people.stats", "max_age")
        self.mortality_rate = self.config_util \
            .getDictionary("covid.stats", "mortality_rate")
        self.social_distance_per = self.config_util \
            .getFloatValue("people.stats", "social_distancing_percent")
        self.infection_range = self.config_util \
            .getFloatValue("covid.stats", "infection_range")
        self.recovery_time = self.config_util \
            .getFloatValue("covid.stats", "recovery_time")
        self.total_healthcare_capacity = \
            self.size*(self.config_util
                       .getIntegerValue("area.stats",
                                        "healthcare_capacity_ratio")/100)
        self.mask_effectiveness = self.config_util \
            .getDictionary("covid.stats", "mask_effectiveness")
        self.speed = self.config_util.getFloatValue("people.stats", "speed")
        self.enforce_social_distance_at = self.config_util \
            .getIntegerValue("area.stats", "enforce_social_distancing_at")
        self.enforce_mask_wearing_at = self.config_util \
            .getIntegerValue("area.stats", "enforce_mask_wearing_at")
    ...
    def runNoUI(self) -> None:
        ...
        self.load_config()
        self.p_util = PopulationUtil(k=self.k, r=self.r,
        ...
        self.visualize = Visualization(self.p_util, render_mode=False)
    ...
    def render(self, path: str) -> None:
        ...
        self.p_util = PopulationUtil(k=self.k, r=self.r,
                                     ...
                                     social_distancing_at=self.enforce_social_distance_at,
                                     mask_wearing_at=self.enforce_mask_wearing_at)
        Visualization(self.p_util, render_mode=True, render_path=path)
